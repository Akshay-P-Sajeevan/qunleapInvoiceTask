...
<body>
    <div class="container">
        ...
        <form action="{{ route('estimates.store') }}" method="POST">
            ...
            <input type="text" id="estimate_number" name="estimate_number" value="{{ old('estimate_number') }}" required>
            ...
            <input type="number" step="0.01" id="estimated_amount" name="estimated_amount" value="{{ old('estimated_amount') }}" required>
